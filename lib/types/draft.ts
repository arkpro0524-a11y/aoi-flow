...
export type CmOverlay = {
  ...
  logoEnabled: boolean;
  logoPosition: CmOverlayPosition;
  logoWidth: number;
  logoOpacity: number;
};
...
export type DraftDoc = {
  ...
  ecDescription?: string;
  ecBullets?: string[];
  savedCaptionSets?: SavedCaptionSet[];
