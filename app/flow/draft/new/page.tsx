            ...
            <div className="space-y-2">
              {d.ig3.map((t, i) => (
                <button
                  ...
                  className="w-full text-left rounded-xl border border-white/12 bg-black/25 hover:bg-black/35 transition p-3"
                  style={{ color: UI.FORM.text, fontSize: UI.FONT.inputPx, lineHeight: UI.FONT.inputLineHeight as any }}
                >
