...
export default function InboxPage() {
  ...
  const MobileCard = (d: Draft) => {
    const title = d.caption_final || d.vision || "（本文なし）";
    const brand = (d.brand || "vento").toUpperCase();
        ...
        <div className="rounded-2xl border border-white/10 bg-black/25 hover:bg-black/30 transition p-3">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              <div className="text-xs text-white/65 font-bold">{brand} / 投稿待ち</div>
              <div
          ...
          <div className="mt-3 flex items-center gap-3">
            ...
            <div className="text-xs text-white/55">
              タップで編集
              <div className="mt-1 text-[11px] text-white/45">READY</div>
            </div>
          </div>
        </div>
      </Link>
